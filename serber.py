...
def handle_info():
    ...
    return {
        "apiversion": "1",
        "author": "CaribbeanCool",  # TODO: Your Battlesnake Username
...
def handle_move():
    ...
    possible_moves = server_logic.avoid_borders(data, possible_moves)
    move = server_logic.food(my_head, data, my_body, possible_moves)
